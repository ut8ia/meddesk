...
use app\modules\desk\models\ExpertPatientsLink;
use Yii;
use yii\base\Model;
 ...
 */
class MypatientsSearch extends Patients
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Patients::find()
            ->joinWith('expertPatientsLink')
            ->where([ExpertPatientsLink::tableName(). '.expert_id' => Yii::$app->user->identity->id]);
