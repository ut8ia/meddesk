...
/**
 * MymeetsSearch represents the model behind the search form of `app\modules\desk\models\Meets`.
 */
class MymeetsSearch extends Meets
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Meets::find()
        ->where(['expert_id'=>Yii::$app->user->identity->id]);
